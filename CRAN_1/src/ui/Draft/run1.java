...
import ui.Share_bag.*;
import ui.running.SystemBandResModel;
import ui.running.UEModifyModel;
import ui.running.UETrafficModel;
import ui.running.WirelessLinkModel;
...
public class run1 extends JDialog implements ActionListener{
	...
	ActionListener7,ActionListener8,ActionListener9;
	JTextField jtk1,jtk2;
	WirelessLinkModel k_table;
	JRadioButton jr1,jr2,jr3,jr4,jr5,jr6,jr7,jr8;//单选框
	ButtonGroup bg;
	JPanel panel_14_1,panel_14_2,panel_14_3,panel_14_4,panel_14_5,panel_14_6,panel_14_7,panel_14_8;
...
//	private JTextField textField_rru;
	...
	JTextField textFieldv1,textFieldv2,textFieldd1,textFieldd2;
	...
	String []jg1={"随机模型","自定义模型"};
	String []jg2={"活跃","不活跃"};
	String []jg4={"自由空间模型","自由+衰落","Hata231","Hata231修正","自定义模型"};

	String []jg8={"待定"};
	String []jg5={"RR","Max C/I","PF"};
	String []jg6={"VoIP/非VoIP","自定义"};
	String []jg7={"预设业务量","待定"};
	...
	UETrafficModel vo_table,vo_table_judge;
...
//		panel_5.add(label_1);
		...
		label_11 = new JLabel("配置文件：");
		label_11.setFont(MyTools.f15);
		panel_7.add(label_11);		
		textField_12 = new JTextField();
		panel_7.add(textField_12);
		textField_12.setColumns(13);	
...
//		label_2 = new JLabel("场景模型参数配置");
//		label_2.setFont(MyTools.f1);
//		panel_6.add(label_2);
//右边		
		cl=new CardLayout();
		...
		panel_14_1 = new JPanel();//移动性模型-随机模型
		panel_14_1.setOpaque(false);
		panel_14_2 = new JPanel();//移动模型-自定义模型
		...
		panel_14_9 = new JPanel();//VoIP
		panel_14_9.setOpaque(false);
		panel_14_10 = new JPanel();//非VoIP
		panel_14_10.setOpaque(false);
		panel_14_11 = new JPanel();//网络业务量模型
		panel_14_11.setOpaque(false);
		// 卡片类型布局
		panel_35.add("1",panel_14_1);//移动性模型-随机模型
		panel_35.add("2",panel_14_2);//移动模型-自定义模型
		...
		panel_35.add("7",panel_14_3_4);//无线链路模型:自定义模型
		panel_35.add("8",panel_14_4);//用户状态
		panel_35.add("9",panel_14_5);//频带划分
		panel_35.add("10",panel_14_6);//RR
		panel_35.add("11",panel_14_7);//Max C/I
		panel_35.add("12",panel_14_8);//PF
		panel_35.add("13",panel_14_9);//VoIP用户占比
		panel_35.add("14",panel_14_10);//非VoIP
		panel_35.add("15",panel_14_11);//网络业务量模型
		...
		if(arg0.getSource()==jr1)
		{
			...
			ActionListener1=new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					{
						if(jcb1.getSelectedIndex()==0)//移动性模型-随机模型
						{
							panel_14_1.removeAll();
							panel_14_1.setLayout(new GridLayout(6, 1, 0, 0));
							{
								...
								panel_14_1.add(pl1);
								{
									...
									try {
										...
										{
											jgid.add(uegroup_rs.getString(1));//ue群id一共有哪些
										}
									...
									jcbid.addActionListener(new ActionListener() {
										...
										public void actionPerformed(ActionEvent e) {
											...
											{
												if(jcbid.getSelectedIndex()==0)//全部用户时
												{
													String sql1="select * from UEModifyModel where AllUeModel=?";//再从UE中调出添加的数据		
													String []paras1={"0"};//可以显示所有已经添加的UE
													ue_table=new UEModifyModel();
													ue_table.table_search(sql1,paras1);
													ue_table_judge=new UEModifyModel();
													boolean a=ue_table_judge.judge_search(sql1, paras1);
													if(a)
													{
														textFieldv1.setText((String) ue_table.getValueAt(0, 5));
														textFieldv2.setText((String) ue_table.getValueAt(0, 4));
														textFieldd1.setText((String) ue_table.getValueAt(0, 7));
														textFieldd2.setText((String) ue_table.getValueAt(0, 6));
//														textField_14.setText((String) ue_table.getValueAt(0, 5));//横坐标X范围
//														textField_15.setText((String) ue_table.getValueAt(0, 5));//横坐标X范围
//														textField_16.setText((String) ue_table.getValueAt(0, 5));//纵坐标Y范围
//														textField_17.setText((String) ue_table.getValueAt(0, 5));//纵坐标Y范围
													}else
													{
														textFieldv1.setText("");
														textFieldv2.setText("");
												...
												{
													String sql1="select * from UEModifyModel where UeGroupId=?";//再从UE中调出添加的数据		
													String selected=(String) jcbid.getSelectedItem();
							...
							}
							{
								...
								panel_14_1.add(pl2);
								{
									...
									textFieldv1.setFont(MyTools.f15);
									pl2.add(textFieldv1);
									textFieldv1.setColumns(8);
									...
									textFieldv2.setFont(MyTools.f15);
									pl2.add(textFieldv2);
									textFieldv2.setColumns(8);
								}
							}
							{
								JPanel pl2= new JPanel();
								...
								panel_14_1.add(pl2);
								{
									JLabel label_19=new JLabel("方向区间：      ");
									label_19.setFont(MyTools.f15);
									pl2.add(label_19);
									
									textFieldd1 = new JTextField();
									textFieldd1.setFont(MyTools.f15);
									pl2.add(textFieldd1);
									textFieldd1.setColumns(8);
									...
									textFieldd2.setFont(MyTools.f15);
									pl2.add(textFieldd2);
									textFieldd2.setColumns(8);
								}
							}
							...
							}
							{
								...
								panel_14_1.add(pl4);								
								{
									ActionListener6=new ActionListener(){
										public void actionPerformed(ActionEvent arg0) {
											if(arg0.getSource()==jb1)//修改
											{
												if(jcbid.getSelectedIndex()==0)//选择全部用户时
												{
													String sql="update UEModifyModel set VelocityUpper=?,VelocityLower=?,DirectionUpper=?,DirectionLower=? where AllUeModel=?";
													String []paras={textFieldv2.getText(),textFieldv1.getText(),textFieldd2.getText(),textFieldd1.getText(),"0"};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
												}
												else
												{
													String sql="update UEModifyModel set VelocityUpper=?,VelocityLower=?,DirectionUpper=?,DirectionLower=? where UeGroupId=?";
													String []paras={textFieldv2.getText(),textFieldv1.getText(),textFieldd2.getText(),textFieldd1.getText(),(String) jcbid.getSelectedItem()};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
												}	
											}
											else if(arg0.getSource()==jb0)//保存
											{
												if(jcbid.getSelectedIndex()==0)//选择全部用户时
												{
													//得到最大编号
													String sql0="exec ModelRowMax ?";
													String []paras0={"UEModifyModel"};
													...
													String sql="insert into UEModifyModel values(?,?,?,?,?,?,?,?)";
													String []paras={string_max_num,"1","0","-1",textFieldv2.getText(),textFieldv1.getText(),textFieldd2.getText(),textFieldd1.getText()};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
												}
												else
												{
													...
													String sql="insert into UEModifyModel values(?,?,?,?,?,?,?,?)";
													String []paras={string_max_num,"1","1",(String) jcbid.getSelectedItem(),textFieldv2.getText(),textFieldv1.getText(),textFieldd2.getText(),textFieldd1.getText()};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
												}	
												//保存成功
											...
											else if(arg0.getSource()==jb2)//删除
											{
												if(jcbid.getSelectedIndex()==0)//选择全部用户时
												{
													String sql="delete from UEModifyModel where AllUeModel=?";
													String []paras={"0"};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
													textFieldv1.setText("");
												...
												{
													String sql="delete from UEModifyModel where UeGroupId=?";
													String []paras={(String) jcbid.getSelectedItem()};
													ue_table=new UEModifyModel();
													ue_table.add_delete_change_to_sql(sql, paras);
													textFieldv1.setText("");
													textFieldv2.setText("");
									...
									jb0=new JButton("保存");
									jb0.setFont(MyTools.f14);
									jb0.addActionListener(ActionListener6);
									jb1=new JButton("修改");
									jb1.setFont(MyTools.f14);
									jb1.addActionListener(ActionListener6);
									jb2=new JButton("删除");
									jb2.setFont(MyTools.f14);
									jb2.addActionListener(ActionListener6);
									pl4.add(jb0);
									pl4.add(jb1);
									pl4.add(jb2);
								}
						...
						else if(jcb1.getSelectedIndex()==1)//移动模型-自定义模型
						{
							panel_14_2.removeAll();
							JLabel jlb1=new JLabel("自定义模型参数-待定");
							jlb1.setFont(MyTools.f15);
							panel_14_2.add(jlb1);
							cl.show(panel_35,"2");  
							panel_35.validate(); 
		...
		else if(arg0.getSource()==jr2)//用户状态
		{
		...
		else if(arg0.getSource()==jr4)
		{
			...
			panel_14_3_1.removeAll();
			panel_14_3_2.removeAll();
			panel_14_3_3.removeAll();
			panel_14_3_4.removeAll();
			//无效化
			useless();
...
//							
							//搜索
//							String sql1="select * from WirelessLinkModel where 1=?";//再从UE中调出添加的数据	
//							String []paras1={"1"};//可以显示所有已经添加的UE
//							k_table=new WirelessLinkModel();
//							k_table.table_search(sql1,paras1);
//							
//							panel_14_3.removeAll();
//							panel_14_3.setLayout(new GridLayout(7, 1, 0, 0));
//							{
//								
//								JPanel pl4= new JPanel();
//								pl4.setOpaque(false);
//								pl4.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
//								panel_14_3.add(pl4);
//								{
//									JLabel label_21 = new JLabel(" 模型环境：");
//									label_21.setFont(MyTools.f14);
//									pl4.add(label_21);
//									jcb9=new JComboBox<>(jg9);
//									jcb9.setFont(MyTools.f14);
//									jcb9.setBackground(Color.white);
//									jcb9.setPreferredSize(new Dimension(113,20));
//									
//									String sql0="select * from WirelessLinkModel where 1=?";//再从UE中调出添加的数据		
//									String []paras0={"1"};
//									k_table_judge=new WirelessLinkModel();
//									boolean a=k_table_judge.judge_search(sql0, paras0);
//									if(a)
//									{
//										if(k_table.getValueAt(0, 3).equals("0"))
//										{
//											jcb9.setSelectedIndex(0);
//											jcb9.repaint();
//										}
//										else if(k_table.getValueAt(0, 3).equals("1"))
//										{
...
//								panel_14_3.add(pl5);
//								{
//									JLabel label_22 = new JLabel("频率范围：");
//									label_22.setFont(MyTools.f15);
//									pl5.add(label_22);
//									jcb10=new JComboBox<>(jg10);
//									jcb10.setPreferredSize(new Dimension(113,20));
//									jcb10.setFont(MyTools.f14);
...
//									if(a)
//									{
//										if(k_table.getValueAt(0, 4).equals("0"))
//										{
//											jcb10.setSelectedIndex(0);
//											jcb10.repaint();
//										}
//										else if(k_table.getValueAt(0, 4).equals("1"))
//										{
...
//								pl6.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
//								panel_14_3.add(pl6);
//								JLabel label_k1 = new JLabel("k1：");
//								label_k1.setFont(MyTools.f15);
//								pl6.add(label_k1);
//								jtk1=new JTextField();
//								jtk1.setFont(MyTools.f15);
//								jtk1.setColumns(8);
//								
//								String sql0="select * from WirelessLinkModel where 1=?";//再从UE中调出添加的数据		
//								String []paras0={"1"};
...
//								if(a)
//								{
//									jtk1.setText((String) k_table.getValueAt(0, 5));
//								}
//								else
//								{
//									jtk1.setText("");
...
//								pl7= new JPanel();
//								pl7.setOpaque(false);
//								pl7.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
//								panel_14_3.add(pl7);
//								JLabel label_k2 = new JLabel("k2：");
//								label_k2.setFont(MyTools.f15);
//								pl7.add(label_k2);
//								jtk2=new JTextField();
//								jtk2.setFont(MyTools.f15);
//								jtk2.setColumns(8);
//								String sql0="select * from WirelessLinkModel where 1=?";//再从UE中调出添加的数据		
//								String []paras0={"1"};
//								k_table_judge=new WirelessLinkModel();
...
//								if(a)
//								{
//									jtk2.setText((String) k_table.getValueAt(0, 6));
//								}
//								else
//								{
//									jtk2.setText("");
...
//								public void actionPerformed(ActionEvent arg0) {
//									if(arg0.getSource()==jbHata231change)//修改
//									{
//										String Circumstance_string=String.valueOf(jcb9.getSelectedIndex());
//										String FrequencyRage_string=String.valueOf(jcb10.getSelectedIndex());		
//										String sql="update WirelessLinkModel set Circumstance=?,FrequencyRage=?,K1=?,K2=? where CaseNum=?";
//										String []paras={Circumstance_string,FrequencyRage_string,jtk1.getText(),jtk2.getText(),"1"};
//										k_table=new WirelessLinkModel();
//										k_table.add_delete_change_to_sql(sql, paras);
//										JOptionPane.showMessageDialog(null, "修改成功");//弹出对话框
//									}
//									else if(arg0.getSource()==jbHata231)//添加
//									{
//										
//											//得到最大编号
//											String sql0="exec ModelRowMax ?";
//											String []paras0={"WirelessLinkModel"};
//											maxnum_model=new UEModifyModel();
//											ResultSet maxnum_sql=maxnum_model.total_num_sql(sql0, paras0);
//											try {
//												maxnum_sql.next();
...
//											String string_max_num=Integer.toString(temp_max_num);//数据库中bbu总数
//											
//											String sql="insert into WirelessLinkModel values(?,?,?,?,?,?,?)";
//											String Circumstance_string=String.valueOf(jcb9.getSelectedIndex());
//											String FrequencyRage_string=String.valueOf(jcb10.getSelectedIndex());		
//											String []paras={string_max_num,"1","1",Circumstance_string,FrequencyRage_string,jtk1.getText(),jtk2.getText()};
//											k_table=new WirelessLinkModel();
//											k_table.add_delete_change_to_sql(sql, paras);
//										
//										//添加成功
//										JOptionPane.showMessageDialog(null, "添加成功");//弹出对话框
//									}
//
//								}
//							};
...
//								pl8= new JPanel();
//								pl8.setOpaque(false);
//								pl8.setLayout(new FlowLayout(FlowLayout.RIGHT, 5, 5));
//								panel_14_3.add(pl8);
//								jbHata231=new JButton("添加");
//								jbHata231.setFont(MyTools.f14);
//								jbHata231change=new JButton("修改");
//								jbHata231change.setFont(MyTools.f14);
//								jbHata231.addActionListener(ActionListener8);
//								jbHata231change.addActionListener(ActionListener8);
//								pl8.add(jbHata231);
//								pl8.add(jbHata231change);
//							}
//							{
//								pl9= new JPanel();
//								pl9.setOpaque(false);
//								pl9.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
//								panel_14_3.add(pl9);
//								JLabel jl=new JLabel("150MHz到1000MHz:  k1=69.55，k2=26.16");
//								jl.setFont(MyTools.f15);
//								pl9.add(jl);
//							}
//							{
//								pl10= new JPanel();
//								pl10.setOpaque(false);
//								pl10.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
//								panel_14_3.add(pl10);
//								JLabel jl=new JLabel("1500MHz到2000MHz:  k1=46.3，k2=33.9");	
//								jl.setFont(MyTools.f15);
//								pl10.add(jl);
//							}
//							
...
//							panel_35.validate();
		...
		else if(arg0.getSource()==jr3)//频带划分
		{
			...
			ActionListener4=new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if(arg0.getSource()==jcb6)
					{
						...
						if(jcb6.getSelectedIndex()==0)//用户业务量模型VoIP、非VoIP
						{
							ActionListener9=new ActionListener(){
								public void actionPerformed(ActionEvent arg0) {
									if(arg0.getSource()==jbvo_add)//添加
									{
										if(jtvo_use.getText().equals("")||jtvo_v.getText().equals(""))
										{
											JOptionPane.showMessageDialog(null, "不能为空");//弹出对话框
										}
										else{
											//得到最大编号
											String sql0="exec ModelRowMax ?";
											String []paras0={"UETrafficModel"};
											maxnum_model=new UEModifyModel();
											ResultSet maxnum_sql=maxnum_model.total_num_sql(sql0, paras0);
											try {
												maxnum_sql.next();
											...
											String sql="insert into UETrafficModel values(?,?,?,?,?)";	
											String []paras={string_max_num,"1","1",jtvo_use.getText(),jtvo_v.getText()};
											vo_table=new UETrafficModel();
									...
									if(arg0.getSource()==jbvo_change)//修改
									{
												
										String sql="update UETrafficModel set VoIPRatio=?,[NonVoIP Velocity]=? where CaseNum=?";
										String []paras={jtvo_use.getText(),jtvo_v.getText(),"1"};
										vo_table=new UETrafficModel();
										vo_table.add_delete_change_to_sql(sql, paras);
										JOptionPane.showMessageDialog(null, "修改成功");//弹出对话框
									}
							...
							}
							{
								...
								jbvo_add=new JButton("添加");
								jbvo_add.setFont(MyTools.f14);
								jbvo_add.addActionListener(ActionListener9);
								jbvo_change=new JButton("修改");
						...
						else if(jcb6.getSelectedIndex()==1)//自定义
						{
							//预留
						}
					}
...
//			boolean a=f_table_judge.judge_search(sql1, paras1);
	...
	private void useless() {
		...
		jcb7.removeActionListener(ActionListener5);
	}

...
public class pic_column3 {
	...
	//获取一个数据集对象
	public  pic_column3(String TitleNames,String Xnames,String Ynames,DefaultCategoryDataset datasets){ 
        ...
        customBarRenderer.setSeriesPaint(0, Color.decode("#F8D661")); //格式为：COLOR+“BBGGRR”：BB、GG、RR表示蓝色、绿色和红色的分量，每种颜色的取值范围是00-FF，采用了16进制。

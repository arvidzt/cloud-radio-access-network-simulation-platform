...
public class pic_column2 {
	...
	//获取一个数据集对象
	public  pic_column2(String TitleNames,String Xnames,String Ynames,DefaultCategoryDataset datasets){ 
        ...
        customBarRenderer.setSeriesPaint(0, Color.decode("#00BF00")); //格式为：COLOR+“BBGGRR”：BB、GG、RR表示蓝色、绿色和红色的分量，每种颜色的取值范围是00-FF，采用了16进制。
...
//        barrenderer.setMinimumBarLength(0.05);
